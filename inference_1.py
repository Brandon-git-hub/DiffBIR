# python inference_1.py  --sr_scale 1 --croped
...
from utils.image import auto_resize, pad, CenterCrop
...
def process(
    ...
    #     control_imgs[i] = CenterCrop(control_imgs[i], 512)
...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--ckpt", default='weights/general_full_v1.ckpt', type=str, help="full checkpoint path")
    ...
    parser.add_argument("--swinir_ckpt", type=str, default="weights/general_swinir_v1.ckpt")
    
    parser.add_argument("--input", type=str, default='inputs/Gopro-scene/sharp')
    parser.add_argument("--label", type=str, default='inputs/Gopro-scene/sharp')
    parser.add_argument("--steps", default=50, type=int)
    parser.add_argument("--sr_scale", type=float, default=1)
    parser.add_argument("--repeat_times", type=int, default=1)
    parser.add_argument("--disable_preprocess_model", default=True, action="store_true")
    
    # patch-based sampling
    parser.add_argument("--croped", required=True, action="store_true")
    ...
    parser.add_argument("--output", type=str, default='results/Gopro-scene/sharp')
    parser.add_argument("--show_lq", default=True, action="store_true")
...
def main() -> None:
    ...
    for file_path in list_image_files(args.input, follow_links=True):
        ...
        if args.croped:
            lq = CenterCrop(lq, args.crop_size)
